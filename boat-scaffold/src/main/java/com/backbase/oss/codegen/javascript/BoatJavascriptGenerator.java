...
@Slf4j
public class BoatJavascriptGenerator extends JavascriptClientCodegen {
    public static final String NAME = "boat-javascript";
    ...
    public BoatJavascriptGenerator() {
        super();
        this.outputFolder = "generated-code/boat-javascript";
        this.embeddedTemplateDir = templateDir = NAME;
    }
...
//        apiTemplateFiles.put("apiClient.mustache", ".js");
//        apiTemplateFiles.put("package.mustache", ".js");
...
//            false));
//        this.cliOptions.add(new CliOption(NG_VERSION, "The version of javascript. (At least 10.0.0)").defaultValue(this.ngVersion));
...
//        return "Generates a TypeScript javascript (6.x - 10.x) client library.";
//    }
//
//
...
//                this::applyjavascriptVersion,
//            () -> applyjavascriptVersion(this.ngVersion)
//        );
//
...
//                log.info("  (you can select the javascript version by setting the additionalProperty foundationVersion)");
//            });
//
...
//    }
//
//    private void applyjavascriptVersion(String versionRange) {
...
//            throw new IllegalArgumentException("Only javascript versions >= 10.0.0 are supported.");
//        }
//
...
//    }
//
//    private void addDependencies(SemVer javascriptVersion) {
...
//
//            if (javascriptVersion.atLeast("14.0.0")) {
...
//
//    @Override
//    public BoatJavascriptCodegenOperation fromOperation(String path,
//                                                     String httpMethod,
//                                                     Operation operation,
//                                                     List<Server> servers) {
...
//
//        return new BoatJavascriptCodegenOperation(codegenOperation);
//    }
//
