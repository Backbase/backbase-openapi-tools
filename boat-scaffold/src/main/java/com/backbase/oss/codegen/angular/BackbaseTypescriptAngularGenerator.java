...
public class BackbaseTypescriptAngularGenerator extends AbstractTypeScriptClientCodegen {
    private static final Logger LOGGER = LoggerFactory.getLogger(BackbaseTypescriptAngularGenerator.class);
    ...
    public void processOpts() {
        ...
        if (additionalProperties.containsKey(FOUNDATION_VERSION)) {
            ...
            LOGGER.info("generating code with foundation-ang {} ...", foundationVersion);
            LOGGER.info("  (you can select the angular version by setting the additionalProperty foundationVersion)");
        }
