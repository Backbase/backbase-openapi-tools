...
public class BoatAngularGenerator extends AbstractTypeScriptClientCodegen {
    private static final Logger LOGGER = LoggerFactory.getLogger(BoatAngularGenerator.class);
    ...
    public String getHelp() {
        return "Generates a TypeScript Angular (6.x - 10.x) client library compatible with Backbase. With love from Marco and Bart.";
    }
