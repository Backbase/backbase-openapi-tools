package com.backbase.boat.diff;
...
import com.qdesrame.openapi.diff.output.Render;
...
public class MarkdownRender implements Render {
    ...
    protected String itemEndpoint(String method, String path, String summary) {
        return H4 + CODE + method + CODE + " " + path + "\n\n" + metadata(summary) + "\n";
    }
    ...
    protected String titleH3(String title) {
        return H3 + title + '\n';
    }
