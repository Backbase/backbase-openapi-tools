...
import com.backbase.oss.boat.diff.compare.ListDiff;
import com.backbase.oss.boat.diff.compare.MapKeyDiff;
...
import com.backbase.oss.boat.diff.model.schema.ChangedEnum;
import com.backbase.oss.boat.diff.model.schema.ChangedMaxLength;
import com.backbase.oss.boat.diff.model.schema.ChangedReadOnly;
import com.backbase.oss.boat.diff.model.schema.ChangedRequired;
import com.backbase.oss.boat.diff.model.schema.ChangedWriteOnly;
...
public class SchemaDiffResult {
    ...
    public <V extends Schema<X>, X> Optional<ChangedSchema> diff(
        ...
        ChangedEnum<X> changedEnum = ListDiff.diff(new ChangedEnum<>(left.getEnum(), right.getEnum(), context));
        ChangedReadOnly readOnly = new ChangedReadOnly(left.getReadOnly(), right.getReadOnly(), context);
        ChangedWriteOnly writeOnly = new ChangedWriteOnly(left.getWriteOnly(), right.getWriteOnly(), context);
        ChangedMaxLength maxLength = new ChangedMaxLength(left.getMaxLength(), right.getMaxLength(), context);
