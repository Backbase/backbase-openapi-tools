    ...
    fun validate(context: Context): List<Violation> {
        ...
        return when {
            ...
            context.api.info.license != null ->
                listOf(Violation("OpenAPI must not contain a license  because it's covered by the License Agreement we already negotiate with customers. ", "/openapi".toJsonPointer()))
            else -> emptyList()
        }
    }
}
